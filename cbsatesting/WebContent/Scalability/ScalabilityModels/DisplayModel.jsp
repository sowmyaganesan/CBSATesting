			...
			<div style="width: 97%; height: 300px; overflow: visible;">
			    ...
			    <div dojoType="dijit.layout.TabContainer" style="width: 100%; height: 100%;">
			        ...
			        <div dojoType="dijit.layout.ContentPane" title="Sample Graph">
			        	...
			        	Graph: 
			        	<% if(!(resultset.getString("Name").equalsIgnoreCase("ResponseTime"))||(resultset.getString("Name").equalsIgnoreCase("ScalabilityFactor"))){
			        	out.println("<div id=\"sampleGraph\" style=\"width: 800px; height: 800px;\"></div>");
			        	}
			        	else{
