...
<script type="text/javascript"> 
			...
			function displayModel(modelName)
			{
				...
				document.location.href = "/cbsatesting/Performance/PerformanceModels/DisplayModel.jsp?Name=" + name;
			}
		</script>
<body class="claro">
	<p>
		<a href="../Performance/SaaSEvaluation.jsp"> SaaS Evaluation> </a> <a
			href="../PerformanceValidation.jsp"> Performance Validation> </a> <a
			href="../PerformanceMonitor.jsp"> Performance Monitor> </a> View
		Polygon
	</p>
  ...
  var text3 = new THREE.TextGeometry( z, 
	...
	scene.add(textMesh3);
		...
		dojo.addOnLoad(function() {
			dojo.xhrGet({
				url : "/cbsatesting/Performance/ChartData?modelName="
						+ modelName,
				handleAs : "json",
				load : function(data) {
		...
		function showChart(data) {
			...
			for ( var j = 1; j < 6; j=j+2) {
				...
				if(!modelName.localeCompare("SEC")){
					...
					plotTuble(par1, par2, par3,count*20);
				}
				else if(!modelName.localeCompare("CRAM")){
					plotaxis5d(100);
					add5dText(key1,key2,key3,key4,key5);
					plotTuble5d(par1, par2, par3,par4,par5,count*20);
