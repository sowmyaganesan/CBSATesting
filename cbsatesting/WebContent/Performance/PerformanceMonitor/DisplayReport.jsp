...
<% 
	...
	try {
		...
		ResultSet resultset3 = statement3.executeQuery("SELECT CollectedTime, Data FROM `performancemodeldata` WHERE MetricID=145 ORDER BY `CollectedTime` DESC LIMIT 0 , 9");
		Statement statement4 = connection.createStatement();
		ResultSet resultset4 = statement4.executeQuery("SELECT CollectedTime, Data FROM `performancemodeldata` WHERE MetricID=138 ORDER BY `CollectedTime` DESC LIMIT 0 , 9");
		Statement statement5 = connection.createStatement();
		ResultSet resultset5 = statement5.executeQuery("SELECT CollectedTime, Data FROM `performancemodeldata` WHERE MetricID=6 OR MetricID=11 ORDER BY `CollectedTime` DESC LIMIT 8");
		Statement statement6 = connection.createStatement();
		ResultSet resultset6 = statement6.executeQuery("SELECT CollectedTime, Data FROM `performancemodeldata` WHERE ModelID=10 ORDER BY `CollectedTime` DESC LIMIT 8");
	...
	<head>
        ...
        <script type="text/javascript" src="/cbsatesting/Scalability/PerformanceModels/DisplayModel.js"></script>
